...
### <a id="72bffacc109d51ea286797a7d5079392"></a>Printer
...
- [**2058**Star][2m] [C++] [lordnoteworthy/al-khaser](https://github.com/lordnoteworthy/al-khaser) Public malware techniques used in the wild: Virtual Machine, Emulation, Debuggers, Sandbox detection.
    - Also In Section: [Malware->工具](#e2fd0947924229d7de24b9902e1f54a0) |
...
- [**305**Star][3m] [Ruby] [fozavci/viproy-voipkit](https://github.com/fozavci/viproy-voipkit)  Pen-Test Kit for Metasploit Framework
    - Also In Section: [Pentest->工具->Metasploit->NoCategory](#01be61d5bb9f6f7199208ff0fba86b5d) |
...
### <a id="9081db81f6f4b78d5c263723a3f7bd6d"></a>Collection
...
- [**521**Star][t] [Py] [gyoisamurai/gyoithon](https://github.com/gyoisamurai/gyoithon) a growing penetration test tool using Machine Learning.


### <a id="fc8737aef0f59c3952d11749fe582dac"></a>AutoXxx
...
- [**1881**Star][5m] [Shell] [arismelachroinos/lscript](https://github.com/arismelachroinos/lscript) The LAZY script will make your life easier, and of course faster.
    - Also In Section: [Wireless->NoCategory](#d4efda1853b2cb0909727188116a2a8c) |
- [**1792**Star][t] [Shell] [leebaird/discover](https://github.com/leebaird/discover) Custom bash scripts used to automate various penetration testing tasks including recon, scanning, parsing, and creating malicious payloads and listeners with Metasploit.
    - Also In Section: [Pentest->工具->Metasploit->NoCategory](#01be61d5bb9f6f7199208ff0fba86b5d) |[Recon->工具->NoCategory](#05ab1b75266fddafc7195f5b395e4d99) |[Payload->工具->PayloadGenerate](#ad92f6b801a18934f1971e2512f5ae4f) |
...
### <a id="3ae4408f4ab03f99bab9ef9ee69642a8"></a>DataExfiltration
...
### <a id="adfa06d452147ebacd35981ce56f916b"></a>LateralMovement
...
#### <a id="5b761419863bc686be12c76451f49532"></a>NoCategory
...
#### <a id="01be61d5bb9f6f7199208ff0fba86b5d"></a>NoCategory


- [**19127**Star][4d] [Ruby] [rapid7/metasploit-framework](https://github.com/rapid7/metasploit-framework) Metasploit Framework
- [**1792**Star][t] [Shell] [leebaird/discover](https://github.com/leebaird/discover) Custom bash scripts used to automate various penetration testing tasks including recon, scanning, parsing, and creating malicious payloads and listeners with Metasploit.
    - Also In Section: [Pentest->工具->AutoXxx](#fc8737aef0f59c3952d11749fe582dac) |[Recon->工具->NoCategory](#05ab1b75266fddafc7195f5b395e4d99) |[Payload->工具->PayloadGenerate](#ad92f6b801a18934f1971e2512f5ae4f) |
...
- [**534**Star][4d] [Shell] [r00t-3xp10it/venom](https://github.com/r00t-3xp10it/venom) venom - shellcode generator/compiler/handler (metasploit)
...
- [**305**Star][3m] [Ruby] [fozavci/viproy-voipkit](https://github.com/fozavci/viproy-voipkit)  Pen-Test Kit for Metasploit Framework
    - Also In Section: [Pentest->工具->NoCategory](#2e40f2f1df5d7f93a7de47bf49c24a0e) |
...
- [**858**Star][3m] [Py] [649/memcrashed-ddos-exploit](https://github.com/649/memcrashed-ddos-exploit) DDoS attack tool for sending forged UDP packets to vulnerable Memcached servers obtained using Shodan API
    - Also In Section: [Recon->工具->Shodan](#18c7c1df2e6ae5e9135dfa2e4eb1d4db) |
...
- [**556**Star][2m] [Shell] [offensive-security/kali-linux-docker](https://github.com/offensive-security/kali-linux-docker) PLEASE USE GITLAB
...
### <a id="53f3011d262d2554156afe18d7ad6a43"></a>Log




### <a id="b0233cd346f5ee456ee04bf653b12ae2"></a>Hijack


#### <a id="b087f1741bcf7c449d2910d052a7f312"></a>NoCategory
...
- [**542**Star][8m] [Py] [wyatu/perun](https://github.com/wyatu/perun) 主要适用于乙方安服、渗透测试人员和甲方RedTeam红队人员的网络资产漏洞扫描器/扫描框架
...
- [**1102**Star][3m] [PHP] [tuhinshubhra/red_hawk](https://github.com/tuhinshubhra/red_hawk) All in one tool for Information Gathering, Vulnerability Scanning and Crawling. A must have tool for all penetration testers
    - Also In Section: [Recon->工具->NoCategory](#05ab1b75266fddafc7195f5b395e4d99) |
...
- [**758**Star][2m] [Py] [nekmo/dirhunt](https://github.com/nekmo/dirhunt) Find web directories without bruteforce
    - Also In Section: [Spdier->工具->未分类](#442f9390fd56008def077a21ab65d4aa) |
...
- [**563**Star][8m] [Go] [marco-lancini/goscan](https://github.com/marco-lancini/goscan) Interactive Network Scanner
- [**539**Star][5m] [Py] [cisagov/pshtt](https://github.com/cisagov/pshtt) Scan domains and return data based on HTTPS best practices
...
- [**324**Star][4d] [HTML] [tanjiti/sec_profile](https://github.com/tanjiti/sec_profile) 爬取secwiki和xuanwu.github.io/sec.today,分析安全信息站点、安全趋势、提取安全工作者账号(twitter,weixin,github等)
    - Also In Section: [Recon->工具->SocialNetwork->Github](#8d1ae776898748b8249132e822f6c919) |


### <a id="1927ed0a77ff4f176b0b7f7abc551e4a"></a>PrivacyStorage


#### <a id="1af1c4f9dba1db2a4137be9c441778b8"></a>NoCategory
...
#### <a id="362dfd9c1f530dd20f922fd4e0faf0e3"></a>Steganography
...
- [**1792**Star][t] [Shell] [leebaird/discover](https://github.com/leebaird/discover) Custom bash scripts used to automate various penetration testing tasks including recon, scanning, parsing, and creating malicious payloads and listeners with Metasploit.
    - Also In Section: [Pentest->工具->AutoXxx](#fc8737aef0f59c3952d11749fe582dac) |[Pentest->工具->Metasploit->NoCategory](#01be61d5bb9f6f7199208ff0fba86b5d) |[Payload->工具->PayloadGenerate](#ad92f6b801a18934f1971e2512f5ae4f) |
...
- [**1363**Star][2m] [CSS] [undeadsec/socialfish](https://github.com/undeadsec/socialfish) Educational Phishing Tool & Information Collector
    - Also In Section: [SET->工具->NoCategory](#ce734598055ad3885d45d0b35d2bf0d7) |
...
- [**1102**Star][3m] [PHP] [tuhinshubhra/red_hawk](https://github.com/tuhinshubhra/red_hawk) All in one tool for Information Gathering, Vulnerability Scanning and Crawling. A must have tool for all penetration testers
    - Also In Section: [Scanner->工具->NoCategory](#de63a029bda6a7e429af272f291bb769) |
...
- [**561**Star][1m] [Py] [m4ll0k/infoga](https://github.com/m4ll0k/infoga) Email OSINT
- [**516**Star][1m] [no-github/digital-privacy](https://github.com/no-github/digital-privacy) 一个关于数字隐私搜集、保护、清理集一体的方案,外加开源信息收集(OSINT)对抗
...
### <a id="e945721056c78a53003e01c3d2f3b8fe"></a>SubDomainDiscovery
...
- [**553**Star][9m] [Py] [feeicn/esd](https://github.com/feeicn/esd) Enumeration sub domains(枚举子域名)
...
### <a id="016bb6bd00f1e0f8451f779fe09766db"></a>Fingerprinting
...
### <a id="6ea9006a5325dd21d246359329a3ede2"></a>Collection
...
### <a id="dc74ad2dd53aa8c8bf3a3097ad1f12b7"></a>SocialNetwork


#### <a id="6d36e9623aadaf40085ef5af89c8d698"></a>NoCategory
...
- [**324**Star][4d] [HTML] [tanjiti/sec_profile](https://github.com/tanjiti/sec_profile) 爬取secwiki和xuanwu.github.io/sec.today,分析安全信息站点、安全趋势、提取安全工作者账号(twitter,weixin,github等)
    - Also In Section: [Scanner->工具->Secret](#58d8b993ffc34f7ded7f4a0077129eb2) |
...
- [**2131**Star][2m] [Py] [elceef/dnstwist](https://github.com/elceef/dnstwist) Domain name permutation engine for detecting typo squatting, phishing and corporate espionage
    - Also In Section: [SET->工具->Phish](#290e9ae48108d21d6d8b9ea9e74d077d) |
...
- [**858**Star][3m] [Py] [649/memcrashed-ddos-exploit](https://github.com/649/memcrashed-ddos-exploit) DDoS attack tool for sending forged UDP packets to vulnerable Memcached servers obtained using Shodan API
    - Also In Section: [Pentest->工具->DDOS](#a0897294e74a0863ea8b83d11994fad6) |
...
### <a id="f30507893511f89b19934e082a54023e"></a>SET
...
### <a id="290e9ae48108d21d6d8b9ea9e74d077d"></a>Phish
...
- [**2131**Star][2m] [Py] [elceef/dnstwist](https://github.com/elceef/dnstwist) Domain name permutation engine for detecting typo squatting, phishing and corporate espionage
    - Also In Section: [Recon->工具->DNS](#a695111d8e30d645354c414cb27b7843) |
...
- [**537**Star][2m] [Py] [shellphish/driller](https://github.com/shellphish/driller) augmenting AFL with symbolic execution!
...
### <a id="ab3e6e6526d058e35c7091d8801ebf3a"></a>SpearPhishing
...
## <a id="8f6c7489870c7358c39c920c83fa2b6b"></a>新添加的
...
- [**564**Star][6m] [Ruby] [sliim/pentest-env](https://github.com/sliim/pentest-env) Pentest environment deployer (kali linux + targets) using vagrant and chef.
...
### <a id="4709b10a8bb691204c0564a3067a0004"></a>EnvAutoSetup
...
- [**523**Star][3m] [Py] [unode/firefox_decrypt](https://github.com/unode/firefox_decrypt) Firefox Decrypt is a tool to extract passwords from Mozilla (Firefox/Thunderbird/SeaMonkey) profiles
...
### <a id="86dc226ae8a71db10e4136f4b82ccd06"></a>Password
...
- [**7035**Star][t] [C] [hashcat/hashcat](https://github.com/hashcat/hashcat) World's fastest and most advanced password recovery utility
    - Also In Section: [PostExp->工具->NoCategory](#12abc279c69d1fcf10692b9cb89bcdf7) |
...
### <a id="764122f9a7cf936cd9bce316b09df5aa"></a>Authenticate
...
# <a id="43b0310ac54c147a62c545a2b0f4bce2"></a>Other


***


## <a id="569887799ee0148230cc5d7bf98e96d0"></a>NoCategory
...
# <a id="946d766c6a0fb23b480ff59d4029ec71"></a>Defense
...
- [**552**Star][8m] [Py] [s0md3v/blazy](https://github.com/s0md3v/Blazy) Blazy is a modern login bruteforcer which also tests for CSRF, Clickjacking, Cloudflare and WAF .
- [**540**Star][4d] [Go] [janusec/janusec](https://github.com/janusec/janusec) Janusec Application Gateway, a Golang based application security solution which provides WAF (Web Application Firewall), CC attack defense, unified web administration portal, private key protection, web routing and scalable load balancing.
...
### <a id="ce6532938f729d4c9d66a5c75d1676d3"></a>FireWall
...
### <a id="6543c237786d1f334d375f4d9acdeee4"></a>Privacy
...
# <a id="e25d233159b1dc40898ff0c74574f790"></a>Logging
...
# <a id="9b026a07fdf243c6870ce91f00191214"></a>ThreatHunt
...
# <a id="d6b02213a74372407371f77dd6e39c99"></a>Crypto
...
# <a id="ceb90405292daed9bb32ac20836c219a"></a>Bluetooth
...
# <a id="76df273beb09f6732b37a6420649179c"></a>Browser
...
- [**563**Star][2m] [Py] [pure-l0g1c/instagram](https://github.com/pure-l0g1c/instagram) Bruteforce attack for Instagram
- [**559**Star][1y] [CSS] [hashview/hashview](https://github.com/hashview/hashview) A web front-end for password cracking and analytics
- [**538**Star][27d] [C] [nmap/ncrack](https://github.com/nmap/ncrack) Ncrack network authentication tool
- [**528**Star][3m] [Py] [ypeleg/hungabunga](https://github.com/ypeleg/hungabunga) HungaBunga: Brute-Force all sklearn models with all parameters using .fit .predict!
- [**520**Star][4m] [duyetdev/bruteforce-database](https://github.com/duyetdev/bruteforce-database) Bruteforce database
...
# <a id="785ad72c95e857273dce41842f5e8873"></a>Spdier
...
## <a id="d4efda1853b2cb0909727188116a2a8c"></a>NoCategory
...
- [**1881**Star][5m] [Shell] [arismelachroinos/lscript](https://github.com/arismelachroinos/lscript) The LAZY script will make your life easier, and of course faster.
    - Also In Section: [Pentest->工具->AutoXxx](#fc8737aef0f59c3952d11749fe582dac) |
...
- [**527**Star][] [C++] [cyberman54/esp32-paxcounter](https://github.com/cyberman54/esp32-paxcounter) Wifi & BLE driven passenger flow metering with cheap ESP32 boards
...
- [**274**Star][19d] [Py] [ghostop14/sparrow-wifi](https://github.com/ghostop14/sparrow-wifi) Next-Gen GUI-based WiFi and Bluetooth Analyzer for Linux
    - Also In Section: [Bluetooth->工具](#c72811e491c68f75ac2e7eb7afd3b01f) |
...
### <a id="b5d99a78ddb383c208aae474fc2cb002"></a>PayloadCollection
...
### <a id="b318465d0d415e35fc0883e9894261d1"></a>RAT
...
### <a id="ad92f6b801a18934f1971e2512f5ae4f"></a>PayloadGenerate
...
- [**1792**Star][t] [Shell] [leebaird/discover](https://github.com/leebaird/discover) Custom bash scripts used to automate various penetration testing tasks including recon, scanning, parsing, and creating malicious payloads and listeners with Metasploit.
    - Also In Section: [Pentest->工具->AutoXxx](#fc8737aef0f59c3952d11749fe582dac) |[Pentest->工具->Metasploit->NoCategory](#01be61d5bb9f6f7199208ff0fba86b5d) |[Recon->工具->NoCategory](#05ab1b75266fddafc7195f5b395e4d99) |
...
### <a id="c45a90ab810d536a889e4e2dd45132f8"></a>Botnet
...
### <a id="85bb0c28850ffa2b4fd44f70816db306"></a>Obfuscate
...
### <a id="78d0ac450a56c542e109c07a3b0225ae"></a>PayloadManagement




### <a id="d08b7bd562a4bf18275c63ffe7d8fc91"></a>Ransomware
...
### <a id="82f546c7277db7919986ecf47f3c9495"></a>Keylogger
...
### <a id="63e0393e375e008af46651a3515072d8"></a>PayloadDelivery
...
# <a id="a9494547a9359c60f09aea89f96a2c83"></a>PostExp
...
- [**7035**Star][t] [C] [hashcat/hashcat](https://github.com/hashcat/hashcat) World's fastest and most advanced password recovery utility
    - Also In Section: [Password->工具->Password](#86dc226ae8a71db10e4136f4b82ccd06) |
- [**3369**Star][8d] [C] [screetsec/thefatrat](https://github.com/screetsec/thefatrat) Thefatrat a massive exploiting tool : Easy tool to generate backdoor and easy tool to post exploitation attack like browser attack and etc . This tool compiles a malware with popular payload and then the compiled malware can be execute on windows, android, mac . The malware that created with this tool also have an ability to bypass most AV softw…
    - Also In Section: [Payload->工具->PayloadGenerate](#ad92f6b801a18934f1971e2512f5ae4f) |
...
### <a id="4c2095e7e192ac56f6ae17c8fc045c51"></a>PrivilegeEscalation
...
- [**547**Star][5m] [rhinosecuritylabs/aws-iam-privilege-escalation](https://github.com/rhinosecuritylabs/aws-iam-privilege-escalation) A centralized source of all AWS IAM privilege escalation methods released by Rhino Security Labs.
...
#### <a id="7ed8ee71c4a733d5e5e5d239f0e8b9e0"></a>NoCategory
...
- [**519**Star][12m] [PS] [a-min3/winspect](https://github.com/a-min3/winspect) Powershell-based Windows Security Auditing Toolbox
...
#### <a id="25697cca32bd8c9492b8e2c8a3a93bfe"></a>Domain
...
### <a id="2dd40db455d3c6f1f53f8a9c25bbe63e"></a>Persistence
